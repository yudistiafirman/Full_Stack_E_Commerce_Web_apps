      ...
      return(
        <div className="row">
            ...
            <div className="pa-recomended-card">
                <Skeleton width height={300} duration={0.5} style={{borderBottomLeftRadius: 0, borderBottomRightRadius: 0}} />
                <div className="px-3 pt-3 pb-2 pa-bg-light-grey" style={{borderBottomLeftRadius: 5, borderBottomRightRadius: 5}}>
                <Skeleton width={200} height={10} duration={0.5} />
                ...
                <p className="pa-font-size-14 pa-dark-grey">
                    ...
                    <Skeleton width={45} height={10} duration={0.5} />
                    </span>
                </p>
                </div>
            </div>
